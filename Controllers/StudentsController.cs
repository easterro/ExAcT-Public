...
namespace ExtracurricularActivitiyLog.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        //cause the context to load the Student.Enrollments navigation property
        .Include(s => s.Rosters)
            .ThenInclude(e => e.Clubs)
        //mproves performance in scenarios
        //where the entities returned won't be updated
        ...
        [Bind("FirstName,LastName,StudentID")] Student student)
        {
            try
            {
        ...
        public async Task<IActionResult> EditPost(int? id)
        {
            ...
            if (await TryUpdateModelAsync<Student>(
                studentToUpdate,
                "",
                s => s.FirstName, s => s.LastName, s => s.StudentID))
            {
                try
                {
                    await _context.SaveChangesAsync();
